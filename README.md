<h1 align="center">Привет, меня зовут Илья .КТО ЕЩЕ НЕ ПОНЯЛ Я - Backend-разработчик. А если серьезно стараюсь не цепляться ни за какой стек . от 🥖 до solidity😏</h1>
